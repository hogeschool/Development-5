...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_FetchData__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Counter__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_MovieContainer__ = __webpack_require__(14);
...
const routes = __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__components_Layout__["a" /* Layout */], null,
    ...
    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], { path: '/movies', component: __WEBPACK_IMPORTED_MODULE_6__components_MovieContainer__["a" /* MovieContainer */] }));
...
let routes = __WEBPACK_IMPORTED_MODULE_6__routes__["a" /* routes */];
function renderApp() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_isomorphic_fetch__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_isomorphic_fetch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_isomorphic_fetch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_immutable__ = __webpack_require__(18);
...
class MovieContainer extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor() {
        ...
        this.loadMovies = function () {
            return __awaiter(this, void 0, void 0, function* () {
                let res = yield fetch("./api/movies", { method: "GET", headers: { "content-type": "application/json" } });
                let movies = yield res.json();
                return movies;
            });
        };
    ...
    componentWillMount() {
        this.loadMovies().then(data => (this.setState(Object.assign({}, this.state, { movieList: __WEBPACK_IMPORTED_MODULE_2_immutable__["List"](data) }))))
            .catch(Error => console.error(Error));
    }
    renderMoviesTable(ml) {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("table", { className: "table" },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("thead", null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("tr", null,
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Title"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Release"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("th", null, "Actors"))),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("tbody", null, ml.map((m) => (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](MovieRow, { movieP: m }))))));
    }
    //ternary
    render() {
        let content = this.state.movieList == "Loading" ? (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, "Loading...."))
            : (this.renderMoviesTable(this.state.movieList));
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null,
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h1", null, "Movies"),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, "This component will fetch movie data from the the server"),
            content));
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = MovieContainer;

class MovieRow extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor() {
        super();
        this.viewActors = function () {
            let movie = this.props.movieP;
            this.setState(Object.assign({}, this.state, { viewActors: !this.state.viewActors }));
        };
        this.state = { viewActors: false };
    }
    render() {
        let movie = this.props.movieP;
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("tr", { key: movie.id },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, movie.title),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null, movie.release),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("td", null,
                !this.state.viewActors ? __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: () => this.viewActors() }, "+")
                    : __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: () => this.viewActors() }, "-"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, this.state.viewActors ? movie.actors.map((a) => __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, a.name)) : __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null)))));
    }
}
/* unused harmony export MovieRow */
            ...
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: 'navbar navbar-inverse' },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: 'navbar-header' },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { type: 'button', className: 'navbar-toggle', "data-toggle": 'collapse', "data-target": '.navbar-collapse' },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: 'icon-bar' }),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: 'icon-bar' })),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { className: 'navbar-brand', to: '/' }, "lesson6")),
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("ul", { className: 'nav navbar-nav' },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["NavLink"], { to: '/fetchdata', activeClassName: 'active' },
                                ...
                                " Fetch data")),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["NavLink"], { to: '/movies', activeClassName: 'active' },
                                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: 'glyphicon glyphicon-th-list' }),
                                " Show Movies"))))));
    }
}
